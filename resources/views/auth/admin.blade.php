            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate id="formLogin" method="post" action="">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100 btn-submit" type="submit">Login</button>
                    </div>
                    <div class="col-12">
      ...
      $('#formLogin').on('submit',function(e){
            ...
            $.ajax({
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    $('.btn-submit').prop('disabled',false);
                    $('.btn-submit').text('Login');
                    alert("Terjadi kesalahan, Harap menghubungi administrator anda!");
                }
            })
            e.preventDefault();
        })
