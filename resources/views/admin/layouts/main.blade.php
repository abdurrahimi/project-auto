...
<head>
  ...
  <link href="{{asset('public/assets/vendor/datatables/dataTables.bootstrap5.min.css')}}" rel="stylesheet" type="text/css" />
  <link href="{{asset('public/assets/vendor/datatables/responsive.bootstrap5.min.css')}}" rel="stylesheet" type="text/css" />
...
<body>
  ...
  <script src="{{asset('public/assets/vendor/datatables/dataTables.bootstrap5.min.js')}}"></script>
  <!-- Responsive examples -->
  <script src="{{asset('public/assets/vendor/datatables/dataTables.responsive.min.js')}}"></script>
  <script src="{{asset('public/assets/vendor/datatables/responsive.bootstrap5.min.js')}}"></script>
